...
def load_content(day):
    # Mapeamento de arquivos (ajustando para os nomes finais gerados)
    file_map = {
    ...
    if day == 21:
        # Carrega as 3 partes do intensivão
        ...
        full_content = ""
        for p in parts:
            path = f"/home/ubuntu/cortex_ia_app/content/{p}"
    ...
    path = f"/home/ubuntu/cortex_ia_app/content/{filename}"
